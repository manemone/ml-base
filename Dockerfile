...
WORKDIR /root
RUN wget https://bootstrap.pypa.io/get-pip.py && python get-pip.py && rm -rf ~/get-pip.py ~/.cache/pip && pip install numpy scipy tqdm scikit-image seaborn easydict opencv-contrib-python chainer keras
